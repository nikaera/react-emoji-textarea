...
`;
const EmojiSelected = styled_components_1.default.span `
  font-size: 1.3em;
`;
...
const SuggestArea = (props) => {
    ...
    const selectedEmojiInfo = (highlight) => {
        ...
        if (emoji) {
            ...
            return (jsx_runtime_1.jsxs(EmojiInfoDiv, { children: [jsx_runtime_1.jsx(EmojiSelected, { children: emoji.native }, void 0), jsx_runtime_1.jsx("br", {}, void 0), jsx_runtime_1.jsx(EmojiColonsP, { children: short_names.map((s) => {
