    ...
    Mi ||
      ...
      process.env.NODE_ENV !== 'production' &&
        (function () {
            ...
            return !!(
              ...
              (typeof s == 'object' &&
                ...
                (s.$$typeof === m ||
                  ...
                  s.$$typeof === t ||
                  s.$$typeof === l ||
                  s.$$typeof === d || // This needs to include all possible module reference object
          ...
          var Oe = C.ReactCurrentDispatcher,
            Ie;
          function ye(s, v, g) {
            {
              if (Ie === void 0)
...
` + S[q].replace(' at new ', ' at ');
          ...
          function xe(s, v, g) {
            if (s == null) return '';
            if (typeof s == 'function') return ui(s, jn(s));
            if (typeof s == 'string') return ye(s);
            switch (s) {
              case c:
                return ye('Suspense');
              case o:
          ...
          var ke = Object.prototype.hasOwnProperty,
            ci = {},
            vi = C.ReactDebugCurrentFrame;
          function Ce(s) {
            if (s) {
              var v = s._owner,
                g = xe(s.type, s._source, v ? v.type : null);
              vi.setExtraStackFrame(g);
            } else vi.setExtraStackFrame(null);
          }
          function $n(s, v, g, b, $) {
            {
          ...
          function Ln(s, v, g, b, $) {
            {
              var z,
                ...
                L = null;
              (g !== void 0 && (ki(g), (S = '' + g)),
                En(v) && (ki(v.key), (S = '' + v.key)),
                qn(v) && ((L = v.ref), Tn(v, $)));
              for (z in v) ke.call(v, z) && !Rn.hasOwnProperty(z) && (F[z] = v[z]);
              if (s && s.defaultProps) {
                var q = s.defaultProps;
                for (z in q) F[z] === void 0 && (F[z] = q[z]);
              }
              if (S || L) {
          ...
          var Ve = C.ReactCurrentOwner,
            _i = C.ReactDebugCurrentFrame;
          function de(s) {
            if (s) {
              var v = s._owner,
                g = xe(s.type, s._source, v ? v.type : null);
          ...
          function pi(s, v) {
            {
              ...
              (s &&
                s._owner &&
                s._owner !== Ve.current &&
                (b = ' It was passed a child from ' + J(s._owner.type) + '.'),
                de(s),
                y(
          ...
          function xi(s, v) {
            {
              ...
              else if (Ke(s)) s._store && (s._store.validated = !0);
              else if (s) {
                var $ = x(s);
                if (typeof $ == 'function' && $ !== s.entries)
                  for (var z = $.call(s), F; !(F = z.next()).done; ) Ke(F.value) && pi(F.value, v);
              }
            }
          }
          function In(s) {
            {
              ...
              if (typeof v == 'function') g = v.propTypes;
                ...
                typeof v == 'object' &&
                (v.$$typeof === d || // Note: Memo only checks outer props here.
          ...
          function Gn(s) {
            {
              ...
              s.ref !== null &&
                (de(s), y('Invalid attribute `ref` supplied to `React.Fragment`.'), de(null));
            }
          }
          var Ci = {};
          function Si(s, v, g, b, $, z) {
            {
              ...
              if (F) {
                ...
                if (N !== void 0)
                  if (b)
                    if (Ne(N)) {
                      for (var le = 0; le < N.length; le++) xi(N[le], s);
              ...
              if (ke.call(v, 'key')) {
                var fe = J(s),
                  O = Object.keys(v).filter(function (Yn) {
                    return Yn !== 'key';
                  }),
                  Je =
                    O.length > 0
...
var He,
  ...
  ze = {},
  an = [],
  Qn = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function ne(i, e) {
...
function ni(i, e, n) {
  ...
  if (
    (arguments.length > 2 && (t.children = arguments.length > 3 ? He.call(arguments, 2) : n),
...
function $i(i) {
  ((!i.__d && (i.__d = !0) && we.push(i) && !Pe.__r++) || ji !== _.debounceRendering) &&
    ((ji = _.debounceRendering) || nn)(Pe);
}
function Pe() {
  for (var i; (Pe.__r = we.length); )
    ((i = we.sort(function (e, n) {
    ...
    if (
        ...
        (h = e[o]) == null || typeof h == 'boolean'
          ...
          : typeof h == 'string' || typeof h == 'number' || typeof h == 'bigint'
            ...
            : Array.isArray(h)
              ...
              : h.__b > 0
                ? je(h.type, h.props, h.key, null, h.__v)
                : h) != null
    ) {
      if (
        ((h.__ = n),
      ...
      (ti(i, h, (m = m || ze), r, f, t, l, d, c),
        ...
        w != null
          ...
          : d && m.__e == d && d.parentNode != i && (d = ce(m)));
    }
  for (n.__e = j, o = y; o--; )
    C[o] != null &&
...
function on(i, e, n) {
  for (var a, r = i.__k, f = 0; r && f < r.length; f++)
    (a = r[f]) &&
      ((a.__ = i), (e = typeof a.type == 'function' ? on(a, e, n) : tn(n, a, a, r, a.__e, e)));
  return e;
}
function Re(i, e) {
  return (
...
function Bi(i, e, n) {
  e[0] === '-'
    ? i.setProperty(e, n)
    : (i[e] = n == null ? '' : typeof n != 'number' || Qn.test(e) ? n : n + 'px');
}
  ...
  e: if (e === 'style')
    if (typeof n == 'string') i.style.cssText = n;
      ...
      if ((typeof a == 'string' && (i.style.cssText = a = ''), a))
        for (e in a) (n && e in n) || Bi(i.style, e, '');
    ...
    ((f = e !== (e = e.replace(/Capture$/, ''))),
      ...
      i.l || (i.l = {}),
      (i.l[e + f] = n),
      n ? a || i.addEventListener(e, f ? Pi : zi, f) : i.removeEventListener(e, f ? Pi : zi, f));
    ...
    e: if (typeof D == 'function') {
      if (
        ...
        D.getDerivedStateFromProps != null &&
          (o.__s == o.state && (o.__s = ne({}, o.__s)),
          ne(o.__s, D.getDerivedStateFromProps(x, o.__s))),
        (m = o.props),
        (h = o.state),
        k)
      )
      ...
      ((o.context = y),
        ...
        (o.state = o.__s),
        o.getChildContext != null && (a = ne(ne({}, a), o.getChildContext())),
        k || o.getSnapshotBeforeUpdate == null || (w = o.getSnapshotBeforeUpdate(m, h)),
        (A = c != null && c.type === ue && c.key == null ? c.props.children : c),
        rn(i, Array.isArray(A) ? A : [A], e, n, a, r, f, t, l, d),
        (o.base = e.__e),
        (e.__h = null),
        o.__h.length && t.push(o),
        j && (o.__E = o.__ = null),
...
function ia(i, e, n, a, r, f, t, l) {
  ...
  if ((h === 'svg' && (r = !0), f != null)) {
    for (; w < f.length; w++)
      if ((d = f[w]) && 'setAttribute' in d == !!h && (h ? d.localName === h : d.nodeType === 3)) {
        ((i = d), (f[w] = null));
        break;
      }
  }
  ...
  if (h === null) k === m || (l && i.data === m) || (i.data = m);
    ...
    if (
      ((f = f && He.call(i.childNodes)),
      (c = (k = n.props || ze).dangerouslySetInnerHTML),
    ...
    if ((ea(i, m, k, r, l), o)) e.__k = [];
      ...
      for (w = f.length; w--; ) f[w] != null && fn(f[w]);
    l ||
      ('value' in m &&
        (w = m.value) !== void 0 &&
        (w !== k.value || w !== i.value || (h === 'progress' && !w)) &&
        qe(i, 'value', w, k.value, !1),
      'checked' in m &&
        (w = m.checked) !== void 0 &&
        w !== i.checked &&
        qe(i, 'checked', w, k.checked, !1));
  }
  return i;
}
function ln(i, e, n) {
...
function un(i, e, n) {
  ...
  if (
    ...
    (a = i.ref) && ((a.current && a.current !== i.__e) || ln(a, null, e)),
    (a = i.__c) != null)
  ) {
...
function cn(i, e, n) {
  ...
  (_.__ && _.__(i, e),
    ...
    ti(
      e,
      (i = ((!a && n) || e).__k = ni(ue, null, [i])),
      r || ze,
      ze,
      e.ownerSVGElement !== void 0,
      !a && n ? [n] : r ? null : e.firstChild ? He.call(e.childNodes) : null,
      f,
...
((He = an.slice),
  ...
  (Y.prototype.setState = function (i, e) {
    var n;
    ((n = this.__s != null && this.__s !== this.state ? this.__s : (this.__s = ne({}, this.state))),
      typeof i == 'function' && (i = i(ne({}, n), this.props)),
      i && ne(n, i),
      i != null && this.__v && (e && this.__h.push(e), $i(this)));
  }),
  ...
  (we = []),
  (nn = typeof Promise == 'function' ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
  (Pe.__r = 0));
var aa = 0;
...
function oa() {
  for (const { v: i, emoji: e } of ra) if (vn(e)) return i;
}
function ta() {
  return !vn('🇨🇦');
}
...
function ua({ maxFrequentRows: i, perLine: e }) {
  ...
  if (
    ...
    const f = n.slice(a);
    n = n.slice(0, a);
    for (let t of f) t != r && delete H[t];
    (r && n.indexOf(r) == -1 && (delete H[n[n.length - 1]], n.splice(-1, 1, r)),
      ie.set('frequently', H));
  }
  return n;
}
...
async function ca(i) {
  ...
  if ((e || (e = ee.emojiVersion.value), n || (n = ee.set.value), a || (a = ee.locale.value), p))
    ...
    ((p =
      ...
      (await qi(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/sets/${e}/${n}.json`))),
      (p.emoticons = {}),
      (p.natives = {}),
  ...
  if (
    ((W =
      ...
      (a == 'en'
        ? /* @__PURE__ */ Qi(mn)
        : await qi(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/${a}.json`))),
    i.custom)
  )
    for (let d in i.custom) {
      ...
      if (!(!c.emojis || !c.emojis.length)) {
        (c.id || (c.id = `custom_${d + 1}`),
          c.name || (c.name = W.categories.custom),
...
async function ga(i, { maxResults: e, caller: n } = {}) {
  ...
  if (!a.length) return;
  let r = fi || (fi = Object.values(p.emojis)),
    f,
    t;
  for (const l of a) {
    if (!r.length) break;
...
typeof customElements < 'u' &&
  ...
  customElements.define('em-emoji', li);
var Ei,
  ri = [],
  Ti = _.__b,
  Wi = _.__r,
...
((_.__b = function (i) {
  ...
  (_.diffed = function (i) {
    ...
    e &&
      e.__H &&
      e.__H.__h.length &&
      ((ri.push(e) !== 1 && Ei === _.requestAnimationFrame) ||
        (
          (Ei = _.requestAnimationFrame) ||
          function (n) {
            var a,
              r = function () {
...
(((Te.prototype = new Y()).isPureReactComponent = !0),
  (Te.prototype.shouldComponentUpdate = function (i, e) {
...
((_.unmount = function (i) {
  ...
  (Qe.prototype.render = function (i, e) {
          ...
          return (
            t &&
              (t.__c &&
                ...
                (t.__c.__H = null)),
              (t = Sa({}, t)).__c != null && (t.__c.__P === d && (t.__c.__P = l), (t.__c = null)),
              (t.__k =
                t.__k &&
    ...
    return (r && (r.__h = null), [ni(ue, null, e.__e ? null : i.children), r]);
  }));
...
_.event = function (i) {
  return (
    Vi && (i = Vi(i)),
    (i.persist = za),
    (i.isPropagationStopped = Pa),
    (i.isDefaultPrevented = Ra),
    (i.nativeEvent = i)
  );
};
var Ui = {
...
_.vnode = function (i) {
  ...
  if (typeof e == 'string') {
        ...
        (f === 'defaultValue' && 'value' in n && n.value == null
          ...
          : f === 'download' && t === !0
            ...
            : /ondoubleclick/i.test(f)
              ? (f = 'ondblclick')
              : /^onchange(textarea|input)/i.test(f + e) && !Ba(n.type)
                ? (f = 'oninput')
                : /^onfocus$/i.test(f)
                  ? (f = 'onfocusin')
                  : /^onblur$/i.test(f)
    ...
    (e == 'select' &&
      ...
      (a.value = Re(n.children).forEach(function (l) {
      ...
      (i.props = a),
      n.class != n.className &&
        ((Ui.enumerable = 'className' in n),
        n.className != null && (a.class = n.className),
        Object.defineProperty(a, 'className', Ui)));
  }
  ((i.$$typeof = Ma), Ki && Ki(i));
};
var Ji = _.__r;
...
class Ea extends Te {
  renderIcon(e) {
    ...
    const a = Ee.categories[e.id] || Ee.categories.custom,
      r = this.props.icons == 'auto' ? qa[this.props.theme] : this.props.icons;
    return a[r] || a;
  }
  render() {
    let e = null;
      ...
      children: /* @__PURE__ */ u('div', {
        ...
        children: [
          this.categories.map((n, a) => {
            const r = n.name || W.categories[n.id],
        ...
        return /* @__PURE__ */ u('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ u('div', {
              ...
              children: t.map((l, d) => {
                const c = l.index - (l.index % Fe.rowsPerRender),
...
typeof customElements < 'u' &&
  ...
  customElements.define('em-emoji-picker', De);
var xn = {};
xn = `:host {
  width: min-content;
  height: 435px;
...
`;
const Yi = /* @__PURE__ */ Object.freeze(
      ...
      const Ae = async (M) => {
        ...
        me = (M) => {
          ...
          const P = k.current.selectionStart ?? m.length,
            B = m.slice(0, P).replace(Zi, ''),
            T = m.slice(P),
            R = B + M.skins[0].native + T;
          (h(R),
            l(R),
            C(!1),
            A([]),
            setTimeout(() => {
              k.current &&
                ...
                (k.current.selectionStart = k.current.selectionEnd =
                  B.length + M.skins[0].native.length));
            }, 0));
        },
        be = (M) => {
          if (!k.current) return;
          const P = k.current.selectionStart ?? m.length,
            B = m.slice(0, P),
            T = m.slice(P),
            R = M.native || (M.skins && M.skins[0] && M.skins[0].native) || '',
            G = B + R + T;
          (h(G),
            l(G),
            t && t(M),
            setTimeout(() => {
              k.current &&
                (k.current.focus(),
                (k.current.selectionStart = k.current.selectionEnd = B.length + R.length));
            }, 0));
        },
        J = (M) => {
          x &&
            y.length > 0 &&
            (M.key === 'ArrowDown'
              ? (M.preventDefault(), X((P) => (P + 1) % y.length))
              : M.key === 'ArrowUp'
                ? (M.preventDefault(), X((P) => (P - 1 + y.length) % y.length))
                : M.key === 'Enter' && y[U] && (M.preventDefault(), me(y[U])));
        },
        I = Be([]);
      return (
        Me(() => {
          ...
          if (x && y.length > 0 && I.current[U]) {
            const P = (M = I.current[0]) == null ? void 0 : M.parentElement,
              B = I.current[U];
            if (P && B) {
              ...
              R.top < T.top
                ...
                : R.bottom > T.bottom && B.scrollIntoView({ block: 'end', behavior: 'auto' });
            }
          }
        }, [U, x, y.length]),
        /* @__PURE__ */ K.jsxs('div', {
            ...
            x &&
              ...
              /* @__PURE__ */ K.jsx('div', {
                ...
                children: y.map((M, P) => {
                  let B = M.id,
                    T = Le,
                    R = B.toLowerCase().indexOf(T.toLowerCase()),
                    G = B.slice(0, R),
                    ae = B.slice(R, R + T.length),
                    oe = B.slice(R + T.length);
