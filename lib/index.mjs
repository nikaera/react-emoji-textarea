...
var EmojiTextArea = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { style: { position: "relative", width: "fit-content", overflow: "visible" }, children: [
      /* @__PURE__ */ jsx(
        "textarea",
        {
          ref: textareaRef,
      ...
      suggesting && suggestResults.length > 0 && /* @__PURE__ */ jsx(
        "div",
        {
          style: {
            position: "absolute",
          ...
          children: suggestResults.map((emoji, idx) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { style: { fontSize: 22, marginRight: 12, flexShrink: 0 }, children: emoji.skins[0].native }),
                  /* @__PURE__ */ jsxs(
                    "span",
                    {
                      style: {
                      ...
                      children: [
                        ":",
                        startIdx !== -1 ? /* @__PURE__ */ jsxs(Fragment, { children: [
                          before,
                          /* @__PURE__ */ jsx(
                            "span",
                            {
      ...
      pickerOpen && /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: "100%", left: 0, zIndex: 1e3 }, children: /* @__PURE__ */ jsx(Picker, { data, onEmojiSelect: handlePickerSelect }) })
    ] });
  }
);
...
export {
  EmojiTextArea_default as EmojiTextarea
};
