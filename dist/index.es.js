import We, { useRef as Be, useEffect as Me, useState as se } from "react";
var ii = { exports: {} }, ge = {};
/**
 * @license React
...
function Zn() {
  if (Fi) return ge;
  Fi = 1;
  var i = We, e = Symbol.for("react.element"), n = Symbol.for("react.fragment"), a = Object.prototype.hasOwnProperty, r = i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, f = { key: !0, ref: !0, __self: !0, __source: !0 };
  function t(l, d, c) {
    var o, k = {}, m = null, h = null;
    c !== void 0 && (m = "" + c), d.key !== void 0 && (m = "" + d.key), d.ref !== void 0 && (h = d.ref);
    for (o in d) a.call(d, o) && !f.hasOwnProperty(o) && (k[o] = d[o]);
    if (l && l.defaultProps) for (o in d = l.defaultProps, d) k[o] === void 0 && (k[o] = d[o]);
...
function Xn() {
  return Mi || (Mi = 1, process.env.NODE_ENV !== "production" && function() {
    var i = We, e = Symbol.for("react.element"), n = Symbol.for("react.portal"), a = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), f = Symbol.for("react.profiler"), t = Symbol.for("react.provider"), l = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), c = Symbol.for("react.suspense"), o = Symbol.for("react.suspense_list"), k = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), h = Symbol.for("react.offscreen"), w = Symbol.iterator, j = "@@iterator";
    function x(s) {
    ...
    function A(s, v, g) {
      {
        var b = C.ReactDebugCurrentFrame, $ = b.getStackAddendum();
        $ !== "" && (v += "%s", g = g.concat([$]));
    ...
    var D = !1, Z = !1, U = !1, X = !1, Le = !1, ve;
    ve = Symbol.for("react.module.reference");
    function Ae(s) {
      return !!(typeof s == "string" || typeof s == "function" || s === a || s === f || Le || s === r || s === c || s === o || X || s === h || D || Z || U || typeof s == "object" && s !== null && (s.$$typeof === m || s.$$typeof === k || s.$$typeof === t || s.$$typeof === l || s.$$typeof === d || // This needs to include all possible module reference object
      ...
      if (typeof s == "object")
        switch (s.$$typeof) {
          ...
          case k:
            ...
            return b !== null ? b : J(s.type) || "Memo";
          case m: {
            var $ = s, z = $._payload, F = $._init;
            try {
              return J(F(z));
            } catch {
              return null;
    ...
    var I = Object.assign, M = 0, P, B, T, R, G, ae, oe;
    function te() {
    }
    ...
    function Cn() {
      {
        if (M === 0) {
          P = console.log, B = console.info, T = console.warn, R = console.error, G = console.group, ae = console.groupCollapsed, oe = console.groupEnd;
          var s = {
            configurable: !0,
            enumerable: !0,
            value: te,
...
` + Ie + s;
    ...
    function ui(s, v) {
      ...
      var z;
      z = Oe.current, Oe.current = null, Cn();
      try {
        if (v) {
          var F = function() {
            throw Error();
...
`), L = b.stack.split(`
`), q = S.length - 1, E = L.length - 1; q >= 1 && E >= 0 && S[q] !== L[E]; )
            E--;
          for (; q >= 1 && E >= 0; q--, E--)
            if (S[q] !== L[E]) {
              if (q !== 1 || E !== 1)
...
` + S[q].replace(" at new ", " at ");
                    return s.displayName && N.includes("<anonymous>") && (N = N.replace("<anonymous>", s.displayName)), typeof s == "function" && pe.set(s, N), N;
                  }
                while (q >= 1 && E >= 0);
              break;
            }
        ...
        Ge = !1, Oe.current = z, Sn(), Error.prepareStackTrace = $;
      }
      var le = s ? s.displayName || s.name : "", fe = le ? ye(le) : "";
      return typeof s == "function" && pe.set(s, fe), fe;
    }
    function Mn(s, v, g) {
      return ui(s, !1);
    }
      ...
      if (typeof s == "object")
        switch (s.$$typeof) {
          case d:
            return Mn(s.render);
          case k:
            return xe(s.type, v, g);
          case m: {
            var b = s, $ = b._payload, z = b._init;
            try {
              return xe(z($), v, g);
            } catch {
            }
    ...
    var ke = Object.prototype.hasOwnProperty, ci = {}, vi = C.ReactDebugCurrentFrame;
    function Ce(s) {
      if (s) {
        var v = s._owner, g = xe(s.type, s._source, v ? v.type : null);
          ...
          if (z(s, F)) {
            ...
            try {
              if (typeof s[F] != "function") {
                var L = Error((b || "React class") + ": " + g + " type `" + F + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof s[F] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
            ...
            S && !(S instanceof Error) && (Ce($), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", b || "React class", g, F, typeof S), Ce(null)), S instanceof Error && !(S.message in ci) && (ci[S.message] = !0, Ce($), y("Failed %s type: %s", g, S.message), Ce(null));
          }
      }
    }
    ...
    function ki(s) {
      if (Pn(s))
        return y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", zn(s)), mi(s);
    }
    var gi = C.ReactCurrentOwner, Rn = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Tn(s, v) {
      typeof s.ref == "string" && gi.current;
    }
    function Wn(s, v) {
      {
        var g = function() {
          hi || (hi = !0, y("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", v));
        };
    ...
    function Hn(s, v) {
      {
        var g = function() {
          wi || (wi = !0, y("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", v));
        };
    ...
    function Ln(s, v, g, b, $) {
      {
        var z, F = {}, S = null, L = null;
        g !== void 0 && (ki(g), S = "" + g), En(v) && (ki(v.key), S = "" + v.key), qn(v) && (L = v.ref, Tn(v, $));
        for (z in v)
          ke.call(v, z) && !Rn.hasOwnProperty(z) && (F[z] = v[z]);
        if (s && s.defaultProps) {
        ...
        if (S || L) {
          var E = typeof s == "function" ? s.displayName || s.name || "Unknown" : s;
          S && Wn(F, E), L && Hn(F, E);
        }
        return Dn(s, S, L, $, b, gi.current, F);
      }
    }
    var Ve = C.ReactCurrentOwner, _i = C.ReactDebugCurrentFrame;
    function de(s) {
      if (s) {
        var v = s._owner, g = xe(s.type, s._source, v ? v.type : null);
        _i.setExtraStackFrame(g);
      } else
    ...
    function pi(s, v) {
      {
        ...
        yi[g] = !0;
        var b = "";
        s && s._owner && s._owner !== Ve.current && (b = " It was passed a child from " + J(s._owner.type) + "."), de(s), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', g, b), de(null);
      }
    }
    function xi(s, v) {
      {
        ...
        if (Ne(s))
          ...
          if (typeof $ == "function" && $ !== s.entries)
            for (var z = $.call(s), F; !(F = z.next()).done; )
              Ke(F.value) && pi(F.value, v);
        }
      }
    }
    function In(s) {
    ...
    function Gn(s) {
      {
        for (var v = Object.keys(s.props), g = 0; g < v.length; g++) {
          var b = v[g];
          if (b !== "children" && b !== "key") {
            de(s), y("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", b), de(null);
            break;
          }
        }
        s.ref !== null && (de(s), y("Invalid attribute `ref` supplied to `React.Fragment`."), de(null));
      }
    }
    var Ci = {};
    function Si(s, v, g, b, $, z) {
      {
        var F = Ae(s);
        if (!F) {
          var S = "";
          ...
          L ? S += L : S += bi();
          var q;
          s === null ? q = "null" : Ne(s) ? q = "array" : s !== void 0 && s.$$typeof === e ? (q = "<" + (J(s.type) || "Unknown") + " />", S = " Did you accidentally export a JSX literal instead of a component?") : q = typeof s, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", q, S);
        }
        var E = Ln(s, v, g, $, z);
        if (E == null)
          return E;
        ...
        if (ke.call(v, "key")) {
          var fe = J(s), O = Object.keys(v).filter(function(Yn) {
            return Yn !== "key";
          }), Je = O.length > 0 ? "{key: someKey, " + O.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!Ci[fe + Je]) {
            var Jn = O.length > 0 ? "{" + O.join(": ..., ") + ": ...}" : "{}";
            y(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Je, fe, Jn, fe), Ci[fe + Je] = !0;
          }
        }
        return s === a ? Gn(E) : In(E), E;
      }
    }
    function Nn(s, v, g) {
      return Si(s, v, g, !0);
    ...
    var Un = Vn, Kn = Nn;
    he.Fragment = a, he.jsx = Un, he.jsxs = Kn;
  }()), he;
}
process.env.NODE_ENV === "production" ? ii.exports = Zn() : ii.exports = Xn();
var K = ii.exports;
function Qi(i) {
...
var He, _, en, we, nn, ji, ze = {}, an = [], Qn = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function ne(i, e) {
...
function ni(i, e, n) {
  ...
  if (arguments.length > 2 && (t.children = arguments.length > 3 ? He.call(arguments, 2) : n), typeof i == "function" && i.defaultProps != null) for (f in i.defaultProps) t[f] === void 0 && (t[f] = i.defaultProps[f]);
  return je(i, t, a, r, null);
}
function je(i, e, n, a, r) {
  var f = {
    type: i,
    props: e,
    key: n,
...
function ce(i, e) {
  if (e == null) return i.__ ? ce(i.__, i.__.__k.indexOf(i) + 1) : null;
  for (var n; e < i.__k.length; e++) if ((n = i.__k[e]) != null && n.__e != null) return n.__e;
  return typeof i.type == "function" ? ce(i) : null;
}
function sn(i) {
  var e, n;
  if ((i = i.__) != null && i.__c != null) {
    for (i.__e = i.__c.base = null, e = 0; e < i.__k.length; e++) if ((n = i.__k[e]) != null && n.__e != null) {
...
function $i(i) {
  (!i.__d && (i.__d = !0) && we.push(i) && !Pe.__r++ || ji !== _.debounceRendering) && ((ji = _.debounceRendering) || nn)(Pe);
}
function Pe() {
  for (var i; Pe.__r = we.length; ) i = we.sort(function(e, n) {
    return e.__v.__b - n.__v.__b;
  }), we = [], i.some(function(e) {
    var n, a, r, f, t, l;
    e.__d && (t = (f = (n = e).__v).__e, (l = n.__P) && (a = [], (r = ne({}, f)).__v = f.__v + 1, ti(l, f, r, n.__n, l.ownerSVGElement !== void 0, f.__h != null ? [
      t
    ] : null, a, t ?? ce(f), f.__h), dn(a, f), f.__e != t && sn(f)));
  });
}
function rn(i, e, n, a, r, f, t, l, d, c) {
  var o, k, m, h, w, j, x, C = a && a.__k || an, y = C.length;
  for (n.__k = [], o = 0; o < e.length; o++) if ((h = n.__k[o] = (h = e[o]) == null || typeof h == "boolean" ? null : typeof h == "string" || typeof h == "number" || typeof h == "bigint" ? je(null, h, null, null, h) : Array.isArray(h) ? je(ue, {
    children: h
  }, null, null, null) : h.__b > 0 ? je(h.type, h.props, h.key, null, h.__v) : h) != null) {
    if (h.__ = n, h.__b = n.__b + 1, (m = C[o]) === null || m && h.key == m.key && h.type === m.type) C[o] = void 0;
    else for (k = 0; k < y; k++) {
    ...
    ti(i, h, m = m || ze, r, f, t, l, d, c), w = h.__e, (k = h.ref) && m.ref != k && (x || (x = []), m.ref && x.push(m.ref, null, h), x.push(k, h.__c || w, h)), w != null ? (j == null && (j = w), typeof h.type == "function" && h.__k === m.__k ? h.__d = d = on(h, d, i) : d = tn(i, h, m, C, w, d), typeof n.type == "function" && (n.__d = d)) : d && m.__e == d && d.parentNode != i && (d = ce(m));
  }
  for (n.__e = j, o = y; o--; ) C[o] != null && (typeof n.type == "function" && C[o].__e != null && C[o].__e == n.__d && (n.__d = ce(a, o + 1)), un(C[o], C[o]));
  if (x) for (o = 0; o < x.length; o++) ln(x[o], x[++o], x[++o]);
}
function on(i, e, n) {
  for (var a, r = i.__k, f = 0; r && f < r.length; f++) (a = r[f]) && (a.__ = i, e = typeof a.type == "function" ? on(a, e, n) : tn(n, a, a, r, a.__e, e));
  return e;
}
function Re(i, e) {
...
function tn(i, e, n, a, r, f) {
  var t, l, d;
  if (e.__d !== void 0) t = e.__d, e.__d = void 0;
  else if (n == null || r != f || r.parentNode == null) e: if (f == null || f.parentNode !== i) i.appendChild(r), t = null;
  else {
...
function ea(i, e, n, a, r) {
  var f;
  for (f in n) f === "children" || f === "key" || f in e || qe(i, f, null, n[f], a);
  for (f in e) r && typeof e[f] != "function" || f === "children" || f === "key" || f === "value" || f === "checked" || n[f] === e[f] || qe(i, f, e[f], n[f], a);
}
function Bi(i, e, n) {
  e[0] === "-" ? i.setProperty(e, n) : i[e] = n == null ? "" : typeof n != "number" || Qn.test(e) ? n : n + "px";
}
function qe(i, e, n, a, r) {
  var f;
  e: if (e === "style")
    if (typeof n == "string") i.style.cssText = n;
    else {
      if (typeof a == "string" && (i.style.cssText = a = ""), a) for (e in a) n && e in n || Bi(i.style, e, "");
      if (n) for (e in n) a && n[e] === a[e] || Bi(i.style, e, n[e]);
    }
  else if (e[0] === "o" && e[1] === "n") f = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in i ? e.toLowerCase().slice(2) : e.slice(2), i.l || (i.l = {}), i.l[e + f] = n, n ? a || i.addEventListener(e, f ? Pi : zi, f) : i.removeEventListener(e, f ? Pi : zi, f);
...
function ti(i, e, n, a, r, f, t, l, d) {
  var c, o, k, m, h, w, j, x, C, y, A, D = e.type;
  if (e.constructor !== void 0) return null;
  n.__h != null && (d = n.__h, l = e.__e = n.__e, e.__h = null, f = [
    l
  ]), (c = _.__b) && c(e);
  try {
    e: if (typeof D == "function") {
      if (x = e.props, C = (c = D.contextType) && a[c.__c], y = c ? C ? C.props.value : c.__ : a, n.__c ? j = (o = e.__c = n.__c).__ = o.__E : ("prototype" in D && D.prototype.render ? e.__c = o = new D(x, y) : (e.__c = o = new Y(x, y), o.constructor = D, o.render = na), C && C.sub(o), o.props = x, o.state || (o.state = {}), o.context = y, o.__n = a, k = o.__d = !0, o.__h = []), o.__s == null && (o.__s = o.state), D.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = ne({}, o.__s)), ne(o.__s, D.getDerivedStateFromProps(x, o.__s))), m = o.props, h = o.state, k) D.getDerivedStateFromProps == null && o.componentWillMount != null && o.componentWillMount(), o.componentDidMount != null && o.__h.push(o.componentDidMount);
      else {
        if (D.getDerivedStateFromProps == null && x !== m && o.componentWillReceiveProps != null && o.componentWillReceiveProps(x, y), !o.__e && o.shouldComponentUpdate != null && o.shouldComponentUpdate(x, o.__s, y) === !1 || e.__v === n.__v) {
          o.props = x, o.state = o.__s, e.__v !== n.__v && (o.__d = !1), o.__v = e, e.__e = n.__e, e.__k = n.__k, e.__k.forEach(function(Z) {
            Z && (Z.__ = e);
          }), o.__h.length && t.push(o);
          break e;
        }
        o.componentWillUpdate != null && o.componentWillUpdate(x, o.__s, y), o.componentDidUpdate != null && o.__h.push(function() {
          o.componentDidUpdate(m, h, w);
        });
      }
      o.context = y, o.props = x, o.state = o.__s, (c = _.__r) && c(e), o.__d = !1, o.__v = e, o.__P = i, c = o.render(o.props, o.state, o.context), o.state = o.__s, o.getChildContext != null && (a = ne(ne({}, a), o.getChildContext())), k || o.getSnapshotBeforeUpdate == null || (w = o.getSnapshotBeforeUpdate(m, h)), A = c != null && c.type === ue && c.key == null ? c.props.children : c, rn(i, Array.isArray(A) ? A : [
        A
      ], e, n, a, r, f, t, l, d), o.base = e.__e, e.__h = null, o.__h.length && t.push(o), j && (o.__E = o.__ = null), o.__e = !1;
    } else f == null && e.__v === n.__v ? (e.__k = n.__k, e.__e = n.__e) : e.__e = ia(n.__e, e, n, a, r, f, t, d);
    (c = _.diffed) && c(e);
  } catch (Z) {
    e.__v = null, (d || f != null) && (e.__e = l, e.__h = !!d, f[f.indexOf(l)] = null), _.__e(Z, e, n);
  }
}
function dn(i, e) {
  _.__c && _.__c(e, i), i.some(function(n) {
    try {
...
function ia(i, e, n, a, r, f, t, l) {
  var d, c, o, k = n.props, m = e.props, h = e.type, w = 0;
  if (h === "svg" && (r = !0), f != null) {
    for (; w < f.length; w++) if ((d = f[w]) && "setAttribute" in d == !!h && (h ? d.localName === h : d.nodeType === 3)) {
      i = d, f[w] = null;
      break;
    }
  }
  if (i == null) {
    ...
    i = r ? document.createElementNS("http://www.w3.org/2000/svg", h) : document.createElement(h, m.is && m), f = null, l = !1;
  }
  if (h === null) k === m || l && i.data === m || (i.data = m);
  else {
    if (f = f && He.call(i.childNodes), c = (k = n.props || ze).dangerouslySetInnerHTML, o = m.dangerouslySetInnerHTML, !l) {
      if (f != null) for (k = {}, w = 0; w < i.attributes.length; w++) k[i.attributes[w].name] = i.attributes[w].value;
      (o || c) && (o && (c && o.__html == c.__html || o.__html === i.innerHTML) || (i.innerHTML = o && o.__html || ""));
    }
    if (ea(i, m, k, r, l), o) e.__k = [];
    else if (w = e.props.children, rn(i, Array.isArray(w) ? w : [
      w
    ], e, n, a, r && h !== "foreignObject", f, t, f ? f[0] : n.__k && ce(n, 0), l), f != null) for (w = f.length; w--; ) f[w] != null && fn(f[w]);
    l || ("value" in m && (w = m.value) !== void 0 && (w !== k.value || w !== i.value || h === "progress" && !w) && qe(i, "value", w, k.value, !1), "checked" in m && (w = m.checked) !== void 0 && w !== i.checked && qe(i, "checked", w, k.checked, !1));
  }
  return i;
}
function ln(i, e, n) {
...
function un(i, e, n) {
  var a, r;
  if (_.unmount && _.unmount(i), (a = i.ref) && (a.current && a.current !== i.__e || ln(a, null, e)), (a = i.__c) != null) {
  ...
  if (a = i.__k) for (r = 0; r < a.length; r++) a[r] && un(a[r], e, typeof i.type != "function");
  n || i.__e == null || fn(i.__e), i.__e = i.__d = void 0;
}
function na(i, e, n) {
...
function cn(i, e, n) {
  var a, r, f;
  _.__ && _.__(i, e), r = (a = typeof n == "function") ? null : n && n.__k || e.__k, f = [], ti(e, i = (!a && n || e).__k = ni(ue, null, [
    i
  ]), r || ze, ze, e.ownerSVGElement !== void 0, !a && n ? [
    n
  ] : r ? null : e.firstChild ? He.call(e.childNodes) : null, f, !a && n ? n : r ? r.__e : e.firstChild, a), dn(f, i);
}
He = an.slice, _ = {
  __e: function(i, e) {
    for (var n, a, r; e = e.__; ) if ((n = e.__c) && !n.__) try {
      if ((a = n.constructor) && a.getDerivedStateFromError != null && (n.setState(a.getDerivedStateFromError(i)), r = n.__d), n.componentDidCatch != null && (n.componentDidCatch(i), r = n.__d), r) return n.__E = n;
    } catch (f) {
      i = f;
    }
    throw i;
  }
}, en = 0, Y.prototype.setState = function(i, e) {
  var n;
  n = this.__s != null && this.__s !== this.state ? this.__s : this.__s = ne({}, this.state), typeof i == "function" && (i = i(ne({}, n), this.props)), i && ne(n, i), i != null && this.__v && (e && this.__h.push(e), $i(this));
}, Y.prototype.forceUpdate = function(i) {
  this.__v && (this.__e = !0, i && this.__h.push(i), $i(this));
}, Y.prototype.render = ue, we = [], nn = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Pe.__r = 0;
var aa = 0;
function u(i, e, n, a, r) {
  ...
  if (typeof i == "function" && (f = i.defaultProps)) for (t in f) l[t] === void 0 && (l[t] = f[t]);
...
const da = (() => {
  ...
  return i.font = a + "px Arial, Sans-Serif", i.textBaseline = "top", i.canvas.width = n * 2, i.canvas.height = e, (r) => {
    i.clearRect(0, 0, n * 2, e), i.fillStyle = "#FF0000", i.fillText(r, 0, 22), i.fillStyle = "#0000FF", i.fillText(r, n, 22);
    const f = i.getImageData(0, 0, n, e).data, t = f.length;
    let l = 0;
    for (; l < t && !f[l + 3]; l += 4) ;
    if (l >= t) return !1;
    const d = n + l / 4 % n, c = Math.floor(l / 4 / n), o = i.getImageData(d, c, 1, 1).data;
...
let H = null;
function la(i) {
  H || (H = ie.get("frequently") || {});
  const e = i.id || i;
  e && (H[e] || (H[e] = 0), H[e] += 1, ie.set("last", e), ie.set("frequently", H));
}
function ua({ maxFrequentRows: i, perLine: e }) {
  if (!i) return [];
  H || (H = ie.get("frequently"));
  let n = [];
  if (!H) {
    H = {};
    for (let f in ai.slice(0, e)) {
      const t = ai[f];
      H[t] = e - f, n.push(t);
    }
    return n;
  }
  const a = i * e, r = ie.get("last");
  for (let f in H) n.push(f);
  if (n.sort((f, t) => {
    const l = H[t], d = H[f];
    ...
    for (let t of f)
      t != r && delete H[t];
    r && n.indexOf(r) == -1 && (delete H[n[n.length - 1]], n.splice(-1, 1, r)), ie.set("frequently", H);
  }
  return n;
}
var di = {
...
let Xe = null, kn = null, gn = !1;
function _e(i, { caller: e } = {}) {
  return Xe || (Xe = new Promise((n) => {
    kn = n;
  })), i ? ca(i) : e && !gn && console.warn(`\`${e}\` requires data to be initialized first. Promise will be pending until \`init\` is called.`), Xe;
}
async function ca(i) {
  gn = !0;
  ...
  if (e || (e = ee.emojiVersion.value), n || (n = ee.set.value), a || (a = ee.locale.value), p)
    ...
    p = (typeof i.data == "function" ? await i.data() : i.data) || await qi(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/sets/${e}/${n}.json`), p.emoticons = {}, p.natives = {}, p.categories.unshift({
      id: "frequent",
      emojis: []
    });
    for (const d in p.aliases) {
      const c = p.aliases[d], o = p.emojis[c];
      o && (o.aliases || (o.aliases = []), o.aliases.push(d));
    }
    p.originalCategories = p.categories;
  }
  if (W = (typeof i.i18n == "function" ? await i.i18n() : i.i18n) || (a == "en" ? /* @__PURE__ */ Qi(mn) : await qi(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/${a}.json`)), i.custom) for (let d in i.custom) {
    d = parseInt(d);
    const c = i.custom[d], o = i.custom[d - 1];
    if (!(!c.emojis || !c.emojis.length)) {
      c.id || (c.id = `custom_${d + 1}`), c.name || (c.name = W.categories.custom), o && !c.icon && (c.target = o.target || o), p.categories.push(c);
      for (const k of c.emojis) p.emojis[k.id] = k;
    }
  }
  i.categories && (p.categories = p.originalCategories.filter((d) => i.categories.indexOf(d.id) != -1).sort((d, c) => {
    const o = i.categories.indexOf(d.id), k = i.categories.indexOf(c.id);
    return o - k;
  }));
  let r = null, f = null;
  n == "native" && (r = Ri.latestVersion(), f = i.noCountryFlags || Ri.noCountryFlags());
  let t = p.categories.length, l = !1;
  for (; t--; ) {
    const d = p.categories[t];
    if (d.id == "frequent") {
      let { maxFrequentRows: k, perLine: m } = i;
      k = k >= 0 ? k : ee.maxFrequentRows.value, m || (m = ee.perLine.value), d.emojis = di.get({
        maxFrequentRows: k,
        perLine: m
      });
    }
    ...
    for (; o--; ) {
      const k = d.emojis[o], m = k.id ? k : p.emojis[k], h = () => {
        d.emojis.splice(o, 1);
      };
      ...
      if (f && d.id == "flags" && !_n.includes(m.id)) {
        h();
        continue;
      }
      if (!m.search) {
        ...
        }).flat().filter((j) => j && j.trim()).join(","), m.emoticons) for (const j of m.emoticons)
          p.emoticons[j] || (p.emoticons[j] = m.id);
        let w = 0;
...
function hn(i, e, n) {
  i || (i = {});
  const a = {};
  for (let r in e) a[r] = wn(r, i, e, n);
  return a;
}
function wn(i, e, n, a) {
  const r = n[i];
  let f = a && a.getAttribute(i) || (e[i] != null && e[i] != null ? e[i] : null);
  return r && (f != null && r.value && typeof r.value != typeof f && (typeof r.value == "boolean" ? f = f != "false" : f = r.value.constructor(f)), r.transform && f && (f = r.transform(f)), (f == null || r.choices && r.choices.indexOf(f) == -1) && (f = r.value)), f;
}
const va = /^(?:\:([^\:]+)\:)(?:\:skin-tone-(\d)\:)?$/;
let fi = null;
function ma(i) {
...
async function ga(i, { maxResults: e, caller: n } = {}) {
  if (!i || !i.trim().length) return null;
  e || (e = 90), await _e(null, {
    caller: n || "SearchIndex.search"
  });
  const a = i.toLowerCase().replace(/(\w)-/, "$1 ").split(/[\s|,]+/).filter((l, d, c) => l.trim() && c.indexOf(l) == d);
  if (!a.length) return;
  let r = fi || (fi = Object.values(p.emojis)), f, t;
  for (const l of a) {
    if (!r.length) break;
    f = [], t = {};
    for (const d of r) {
  ...
  return f.length < 2 || (f.sort((l, d) => {
    const c = t[l.id], o = t[d.id];
    return c == o ? l.id.localeCompare(d.id) : c - o;
  }), f.length > e && (f = f.slice(0, e))), f;
}
var re = {
  search: ga,
  get: ma,
...
async function wa(i = 1) {
  for (let e in [
    ...Array(i).keys()
  ]) await new Promise(requestAnimationFrame);
}
function _a(i, { skinIndex: e = 0 } = {}) {
...
function si(i) {
  ...
  if (i.shortcodes) {
    const l = i.shortcodes.match(re.SHORTCODES_REGEX);
    l && (e = l[1], l[2] && (n = l[2]));
  }
  if (a || (a = re.get(e || i.native)), !a) return i.fallback;
  const r = a.skins[n - 1] || a.skins[0], f = r.src || (i.set != "native" && !i.spritesheet ? typeof i.getImageURL == "function" ? i.getImageURL(i.set, r.unified) : `https://cdn.jsdelivr.net/npm/emoji-datasource-${i.set}@15.0.1/img/${i.set}/64/${r.unified}.png` : void 0), t = typeof i.getSpritesheetURL == "function" ? i.getSpritesheetURL(i.set) : `https://cdn.jsdelivr.net/npm/emoji-datasource-${i.set}@15.0.1/img/${i.set}/sheets-256/64.png`;
  return /* @__PURE__ */ u("span", {
    class: "emoji-mart-emoji",
    "data-emoji-set": i.set,
    children: f ? /* @__PURE__ */ u("img", {
      style: {
        maxWidth: i.size || "1em",
...
const pa = typeof window < "u" && window.HTMLElement ? window.HTMLElement : Object;
class bn extends pa {
...
class li extends bn {
  async connectedCallback() {
    const e = hn(this.props, yn, this);
    e.element = this, e.ref = (n) => {
      this.component = n;
    }, await _e(), !this.disconnected && cn(/* @__PURE__ */ u(si, {
      ...e
    }), this);
  }
  constructor(e) {
...
V(li, "Props", yn);
typeof customElements < "u" && !customElements.get("em-emoji") && customElements.define("em-emoji", li);
var Ei, ri = [], Ti = _.__b, Wi = _.__r, Hi = _.diffed, Di = _.__c, Li = _.unmount;
function Ca() {
  var i;
  for (ri.sort(function(e, n) {
    return e.__v.__b - n.__v.__b;
  }); i = ri.pop(); ) if (i.__P) try {
    i.__H.__h.forEach($e), i.__H.__h.forEach(oi), i.__H.__h = [];
  } catch (e) {
...
_.__b = function(i) {
  ...
  Wi && Wi(i);
  var e = i.__c.__H;
  e && (e.__h.forEach($e), e.__h.forEach(oi), e.__h = []);
}, _.diffed = function(i) {
  Hi && Hi(i);
  var e = i.__c;
  e && e.__H && e.__H.__h.length && (ri.push(e) !== 1 && Ei === _.requestAnimationFrame || ((Ei = _.requestAnimationFrame) || function(n) {
    var a, r = function() {
      clearTimeout(f), Ai && cancelAnimationFrame(a), setTimeout(n);
    }, f = setTimeout(r, 100);
    Ai && (a = requestAnimationFrame(r));
  })(Ca));
}, _.__c = function(i, e) {
  e.some(function(n) {
    try {
      n.__h.forEach($e), n.__h = n.__h.filter(function(a) {
        return !a.__ || oi(a);
      });
    } catch (a) {
      e.some(function(r) {
...
(Te.prototype = new Y()).isPureReactComponent = !0, Te.prototype.shouldComponentUpdate = function(i, e) {
  return Oi(this.props, i) || Oi(this.state, e);
};
var Ii = _.__b;
_.__b = function(i) {
  i.type && i.type.__f && i.ref && (i.props.ref = i.ref, i.ref = null), Ii && Ii(i);
};
var Fa = _.__e;
_.__e = function(i, e, n) {
  if (i.then) {
    for (var a, r = e; r = r.__; ) if ((a = r.__c) && a.__c) return e.__e == null && (e.__e = n.__e, e.__k = n.__k), a.__c(i, e);
  }
  Fa(i, e, n);
};
var Gi = _.unmount;
...
_.unmount = function(i) {
  var e = i.__c;
  e && e.__R && e.__R(), e && i.__h === !0 && (i.type = null), Gi && Gi(i);
}, (Qe.prototype = new Y()).__c = function(i, e) {
  var n = e.__c, a = this;
  a.t == null && (a.t = []), a.t.push(n);
  var r = pn(a.__v), f = !1, t = function() {
    ...
    if (!--a.__u) {
      if (a.state.__e) {
        ...
        a.__v.__k[0] = function k(m, h, w) {
          return m && (m.__v = null, m.__k = m.__k && m.__k.map(function(j) {
            return k(j, h, w);
          }), m.__c && m.__c.__P === h && (m.__e && w.insertBefore(m.__e, m.__d), m.__c.__e = !0, m.__c.__P = w)), m;
        }(c, c.__c.__P, c.__c.__O);
      }
      var o;
      for (a.setState({
        __e: a.__b = null
      }); o = a.t.pop(); ) o.forceUpdate();
    }
  }, d = e.__h === !0;
  a.__u++ || d || a.setState({
  ...
  this.t = [];
}, Qe.prototype.render = function(i, e) {
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = function f(t, l, d) {
        ...
        }), t.__c.__H = null), (t = Sa({}, t)).__c != null && (t.__c.__P === d && (t.__c.__P = l), t.__c = null), t.__k = t.__k && t.__k.map(function(c) {
          return f(c, l, d);
        })), t;
  ...
  var r = e.__e && ni(ue, null, i.fallback);
  return r && (r.__h = null), [
    ni(ue, null, e.__e ? null : i.children),
    r
  ];
};
var Ni = function(i, e, n) {
  if (++n[1] === n[0] && i.o.delete(e), i.props.revealOrder && (i.props.revealOrder[0] !== "t" || !i.o.size)) for (n = i.u; n; ) {
    for (; n.length > 3; ) n.pop()();
    if (n[1] < n[0]) break;
    i.u = n = n[2];
  }
};
(Se.prototype = new Y()).__e = function(i) {
  var e = this, n = pn(e.__v), a = e.o.get(i);
  return a[0]++, function(r) {
    var f = function() {
      e.props.revealOrder ? (a.push(r), Ni(e, i, a)) : r();
    };
    n ? n(f) : f();
  };
}, Se.prototype.render = function(i) {
...
var Ma = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, ja = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, $a = typeof document < "u", Ba = function(i) {
...
_.event = function(i) {
  return Vi && (i = Vi(i)), i.persist = za, i.isPropagationStopped = Pa, i.isDefaultPrevented = Ra, i.nativeEvent = i;
};
var Ui = {
  configurable: !0,
  get: function() {
...
_.vnode = function(i) {
  ...
  if (typeof e == "string") {
    ...
    for (var f in a = {}, n) {
      var t = n[f];
      $a && f === "children" && e === "noscript" || f === "value" && "defaultValue" in n && t == null || (f === "defaultValue" && "value" in n && n.value == null ? f = "value" : f === "download" && t === !0 ? t = "" : /ondoubleclick/i.test(f) ? f = "ondblclick" : /^onchange(textarea|input)/i.test(f + e) && !Ba(n.type) ? f = "oninput" : /^onfocus$/i.test(f) ? f = "onfocusin" : /^onblur$/i.test(f) ? f = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp)/.test(f) ? f = f.toLowerCase() : r && ja.test(f) ? f = f.replace(/[A-Z0-9]/, "-$&").toLowerCase() : t === null && (t = void 0), a[f] = t);
    }
    e == "select" && a.multiple && Array.isArray(a.value) && (a.value = Re(n.children).forEach(function(l) {
      l.props.selected = a.value.indexOf(l.props.value) != -1;
    })), e == "select" && a.defaultValue != null && (a.value = Re(n.children).forEach(function(l) {
      l.props.selected = a.multiple ? a.defaultValue.indexOf(l.props.value) != -1 : a.defaultValue == l.props.value;
    })), i.props = a, n.class != n.className && (Ui.enumerable = "className" in n, n.className != null && (a.class = n.className), Object.defineProperty(a, "className", Ui));
  }
  i.$$typeof = Ma, Ki && Ki(i);
};
var Ji = _.__r;
...
class Ea extends Te {
  renderIcon(e) {
    const { icon: n } = e;
    if (n) {
      if (n.svg) return /* @__PURE__ */ u("span", {
        class: "flex",
        dangerouslySetInnerHTML: {
          __html: n.svg
        }
      });
      if (n.src) return /* @__PURE__ */ u("img", {
        src: n.src
      });
    }
    const a = Ee.categories[e.id] || Ee.categories.custom, r = this.props.icons == "auto" ? qa[this.props.theme] : this.props.icons;
    return a[r] || a;
  }
  render() {
    let e = null;
      ...
      children: /* @__PURE__ */ u("div", {
        ...
        children: [
          this.categories.map((n, a) => {
            const r = n.name || W.categories[n.id], f = !this.props.unfocused && n.id == this.state.categoryId;
            return f && (e = a), /* @__PURE__ */ u("button", {
              "aria-label": r,
...
class Wa extends Y {
  ...
  async reset(e = {}) {
    await _e(this.props), this.initGrid(), this.unobserve(), this.setState(e, () => {
  ...
  initGrid() {
    ...
    const a = (r, f) => {
      ...
      const l = this.grid.length - 1, d = l % Fe.rowsPerRender ? {} : Q();
  ...
  initDynamicPerLine(e = this.props) {
    ...
    const { element: n, emojiButtonSize: a } = e, r = () => {
  ...
  getEmojiByPos([e, n]) {
    const a = this.state.searchResults || this.grid, r = a[e] && a[e][n];
    if (r)
      return re.get(r);
  }
  observeCategories() {
  ...
  observeRows() {
    const e = {
      ...
      root: this.refs.scroll.current,
      rootMargin: `${this.props.emojiButtonSize * (Fe.rowsPerRender + 5)}px 0px ${this.props.emojiButtonSize * Fe.rowsPerRender}px`
    });
  ...
  navigate({ e, input: n, left: a, right: r, up: f, down: t }) {
    ...
    const o = (() => {
      if (d == 0 && c == 0 && !e.repeat && (a || f))
        return null;
      if (d == -1)
        return !e.repeat && (r || t) && n.selectionStart == n.value.length ? [
          0,
          0
        ] : null;
      if (a || r) {
        ...
        if (c += m, !k[c]) {
          if (d += m, k = l[d], !k)
            return d = a ? 0 : l.length - 1, c = a ? 0 : l[d].length - 1, [
              d,
              c
            ];
          c = a ? k.length - 1 : 0;
      ...
      if (f || t) {
        d += f ? -1 : 1;
        const k = l[d];
        return k ? (k[c] || (c = k.length - 1), [
          d,
          c
        ]) : (d = f ? 0 : l.length - 1, c = f ? 0 : l[d].length - 1, [
          d,
          c
        ]);
      }
  ...
  scrollTo({ categoryId: e, row: n }) {
    ...
    if (!a.length) return;
    const r = this.refs.scroll.current, f = r.getBoundingClientRect();
    let t = 0;
    if (n >= 0 && (e = a[n].__categoryId), e && (t = (this.refs[e] || this.refs.categories.get(e).root).current.getBoundingClientRect().top - (f.top - r.scrollTop) + 1), n >= 0)
      if (!n) t = 0;
      else {
        const l = a[n].__index, d = t + l * this.props.emojiButtonSize, c = d + this.props.emojiButtonSize + this.props.emojiButtonSize * 0.88;
  ...
  handleEmojiClick({ e, emoji: n, pos: a }) {
    if (this.props.onEmojiSelect && (!n && a && (n = this.getEmojiByPos(a)), n)) {
      ...
      this.props.maxFrequentRows && di.add(r, this.props), this.props.onEmojiSelect(r, e);
    }
  }
  closeSkins() {
  ...
  renderEmojiButton(e, { pos: n, posinset: a, grid: r }) {
    const f = this.props.emojiButtonSize, t = this.state.tempSkin || this.state.skin, d = (e.skins[t - 1] || e.skins[0]).native, c = ha(this.state.pos, n), o = n.concat(e.id).join("");
    return /* @__PURE__ */ u(Ta, {
      ...
      children: /* @__PURE__ */ u("button", {
        ...
        tabindex: "-1",
        onClick: (k) => this.handleEmojiClick({
          e: k,
          emoji: e
        }),
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", {
          children: e.length ? e.map((n, a) => /* @__PURE__ */ u("div", {
            class: "flex",
            children: n.map((r, f) => this.renderEmojiButton(r, {
              pos: [
                a,
                f
              ],
      ...
      children: e.map((r) => {
        ...
        return /* @__PURE__ */ u("div", {
          ...
          children: [
            /* @__PURE__ */ u("div", {
              class: `sticky padding-small align-${this.dir[0]}`,
              children: r.name || W.categories[r.id]
            }),
            /* @__PURE__ */ u("div", {
              class: "relative",
              style: {
              ...
              children: t.map((l, d) => {
                const c = l.index - l.index % Fe.rowsPerRender, o = this.state.visibleRows[c], k = "current" in l ? l : void 0;
                if (!o && !k) return null;
                const m = d * a, h = m + a, w = r.emojis.slice(m, h);
                return w.length < a && w.push(...new Array(a - w.length)), /* @__PURE__ */ u("div", {
                  "data-index": l.index,
                  ref: k,
                  class: "flex row",
                  style: {
                  ...
                  children: o && w.map((j, x) => {
                    if (!j) return /* @__PURE__ */ u("div", {
                      style: {
                        width: this.props.emojiButtonSize,
                        height: this.props.emojiButtonSize
                      }
  ...
  renderSkins() {
    const n = this.refs.skinToneButton.current.getBoundingClientRect(), a = this.base.getBoundingClientRect(), r = {};
    return this.dir == "ltr" ? r.right = a.right - n.right - 3 : r.left = n.left - a.left - 3, this.props.previewPosition == "bottom" && this.props.skinTonePosition == "preview" ? r.bottom = a.bottom - n.top + 6 : (r.top = n.bottom - a.top + 3, r.bottom = "auto"), /* @__PURE__ */ u("div", {
      ref: this.refs.menu,
      role: "radiogroup",
      dir: this.dir,
      "aria-label": W.skins.choose,
      ...
      children: [
        ...
        const t = f + 1, l = this.state.skin == t;
        return /* @__PURE__ */ u("div", {
          children: [
            /* @__PURE__ */ u("input", {
              type: "radio",
  ...
  constructor(e) {
    super(), V(this, "darkMediaCallback", () => {
      ...
      if (!n) return;
      const { value: a } = n, r = await re.search(a), f = () => {
      ...
      let d = null;
      for (let c of r)
        (!l.length || d.length == this.getPerLine()) && (d = [], d.__categoryId = "search", d.__index = l.length, l.push(d)), d.push(c);
    ...
    }), V(this, "handleCategoryClick", ({ category: n, i: a }) => {
      this.scrollTo(a == 0 ? {
        row: -1
      } : {
        categoryId: n.id
      ...
      const { currentTarget: a } = n, r = a.getBoundingClientRect();
      this.setState({
        showSkins: r
      }, async () => {
        await wa(2);
...
class De extends xa {
  async connectedCallback() {
    const e = hn(this.props, ee, this);
    e.element = this, e.ref = (n) => {
      this.component = n;
    }, await _e(e), !this.disconnected && cn(/* @__PURE__ */ u(Wa, {
      ...e
    }), this.shadowRoot);
  }
  constructor(e) {
    super(e, {
      styles: /* @__PURE__ */ Qi(xn)
    });
  }
}
V(De, "Props", ee);
typeof customElements < "u" && !customElements.get("em-emoji-picker") && customElements.define("em-emoji-picker", De);
var xn = {};
xn = `:host {
  width: min-content;
  height: 435px;
...
function Ha(i) {
  const e = Be(null), n = Be(null);
  return n.current && n.current.update(i), Me(() => (n.current = new De({
    ...i,
    ref: e
  }), () => {
    n.current = null;
...
const Da = [
  ...
  ({
    ...
    const k = o || Be(null), [m, h] = se(""), [w, j] = se(r), [x, C] = se(!1), [y, A] = se([]), [D, Z] = se({
      top: 0,
      left: 0
    }), [U, X] = se(0), [Le, ve] = se("");
    Me(() => {
    ...
    const Ae = async (M) => {
      ...
      h(P), l(P);
      const B = P.slice(0, M.target.selectionStart ?? void 0).match(Zi);
      if (B && B[1])
        if (ve(B[1]), /^:[a-zA-Z0-9_+-]+:$/.test(B[0]))
          try {
            const { SearchIndex: T, init: R } = await Promise.resolve().then(() => Yi);
            await R({ data: ei });
            const G = await T.search(B[1]), ae = G.find((oe) => oe.id === B[1]);
            if (ae) {
              me(ae), C(!1), A([]), X(0);
              return;
            }
            C(!0), A(G), X(0), k.current && Z(Xi(k.current));
          } catch {
            A([]);
          }
        else {
          ...
          try {
            const { SearchIndex: T, init: R } = await Promise.resolve().then(() => Yi);
            await R({ data: ei });
            const G = await T.search(B[1]);
            A(G), X(0), k.current && Z(Xi(k.current));
          } catch {
            A([]);
          }
        }
      ...
      if (!k.current) return;
      const P = k.current.selectionStart ?? m.length, B = m.slice(0, P).replace(Zi, ""), T = m.slice(P), R = B + M.skins[0].native + T;
      h(R), l(R), C(!1), A([]), setTimeout(() => {
        k.current && (k.current.focus(), k.current.selectionStart = k.current.selectionEnd = B.length + M.skins[0].native.length);
      }, 0);
    }, be = (M) => {
      if (!k.current) return;
      const P = k.current.selectionStart ?? m.length, B = m.slice(0, P), T = m.slice(P), R = M.native || M.skins && M.skins[0] && M.skins[0].native || "", G = B + R + T;
      h(G), l(G), t && t(M), setTimeout(() => {
        k.current && (k.current.focus(), k.current.selectionStart = k.current.selectionEnd = B.length + R.length);
      }, 0);
    }, J = (M) => {
      x && y.length > 0 && (M.key === "ArrowDown" ? (M.preventDefault(), X((P) => (P + 1) % y.length)) : M.key === "ArrowUp" ? (M.preventDefault(), X((P) => (P - 1 + y.length) % y.length)) : M.key === "Enter" && y[U] && (M.preventDefault(), me(y[U])));
    }, I = Be([]);
    return Me(() => {
      var M;
      if (x && y.length > 0 && I.current[U]) {
        const P = (M = I.current[0]) == null ? void 0 : M.parentElement, B = I.current[U];
        if (P && B) {
          const T = P.getBoundingClientRect(), R = B.getBoundingClientRect();
          R.top < T.top ? B.scrollIntoView({ block: "start", behavior: "auto" }) : R.bottom > T.bottom && B.scrollIntoView({ block: "end", behavior: "auto" });
        }
      }
    }, [U, x, y.length]), /* @__PURE__ */ K.jsxs("div", { style: { position: "relative", width: "fit-content", overflow: "visible" }, children: [
      /* @__PURE__ */ K.jsx(
        "textarea",
        {
          ref: k,
      ...
      x && y.length > 0 && /* @__PURE__ */ K.jsx(
        "div",
        {
          style: {
            ...
            width: "85%",
            fontFamily: "Slack-Lato, apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif",
            fontSize: 15,
            color: "#1d1c1d",
            border: "none",
            padding: "4px 0",
          ...
          children: y.map((M, P) => {
            let B = M.id, T = Le, R = B.toLowerCase().indexOf(T.toLowerCase()), G = B.slice(0, R), ae = B.slice(R, R + T.length), oe = B.slice(R + T.length);
            return /* @__PURE__ */ K.jsxs(
              "div",
              {
                ref: (te) => I.current[P] = te,
                style: {
                  padding: "8px 16px",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
                  background: P === U ? "#e8f5fd" : "transparent",
                  fontWeight: P === U ? 700 : 400,
                  color: P === U ? "#1264A3" : "#1d1c1d",
                  borderRadius: 6
                },
                onMouseDown: (te) => {
                  te.preventDefault(), me(M);
                },
                onMouseEnter: () => X(P),
                children: [
                  /* @__PURE__ */ K.jsx("span", { style: { fontSize: 22, marginRight: 12, flexShrink: 0 }, children: M.skins[0].native }),
                  /* @__PURE__ */ K.jsxs(
                    "span",
                    {
                      style: {
                        fontSize: 14,
                        color: P === U ? "#1264A3" : "#616061",
                        opacity: 0.85
                      },
                      children: [
                        ":",
                        R !== -1 ? /* @__PURE__ */ K.jsxs(K.Fragment, { children: [
                          G,
                          /* @__PURE__ */ K.jsx(
                            "span",
                            {
      ...
      w && /* @__PURE__ */ K.jsx("div", { style: { position: "absolute", top: "100%", left: 0, zIndex: 1e3 }, children: /* @__PURE__ */ K.jsx(
        Ha,
        {
          data: ei,
          onEmojiSelect: be,
