...
var init_module = __esm({
  "node_modules/emoji-mart/dist/module.js"() {
    ...
    $dc040a17866866fa$var$j = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103;
  ...
  ({
    ...
    const handleInput = async (e) => {
      ...
      if (match && match[1]) {
        ...
        if (/^:[a-zA-Z0-9_+-]+:$/.test(match[0])) {
          try {
            const { SearchIndex, init } = await Promise.resolve().then(() => (init_module(), module_exports));
    ...
    const handleSuggestSelect = (emoji) => {
      ...
      setTimeout(() => {
        if (textareaRef.current) {
          textareaRef.current.focus();
          textareaRef.current.selectionStart = textareaRef.current.selectionEnd = before.length + emoji.skins[0].native.length;
        }
      }, 0);
    };
    const handlePickerSelect = (emoji) => {
      ...
      const after = value.slice(cursor);
      const emojiChar = emoji.native || emoji.skins && emoji.skins[0] && emoji.skins[0].native || "";
      ...
      setTimeout(() => {
        if (textareaRef.current) {
          textareaRef.current.focus();
          textareaRef.current.selectionStart = textareaRef.current.selectionEnd = before.length + emojiChar.length;
        }
      }, 0);
    };
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative", width: "fit-content", overflow: "visible" }, children: [
      ...
      suggesting && suggestResults.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
          style: {
            position: "absolute",
          ...
          children: suggestResults.map((emoji, idx) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 22, marginRight: 12, flexShrink: 0 }, children: emoji.skins[0].native }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "span",
                    {
                      ...
                      children: [
                        ":",
                        startIdx !== -1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                          before,
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "span",
                            {
      ...
      pickerOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { position: "absolute", top: "100%", left: 0, zIndex: 1e3 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react2.default, { data: import_data.default, onEmojiSelect: handlePickerSelect }) })
    ] });
  }
);
